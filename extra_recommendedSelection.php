...
<div class="container">
    <div class="row">
        <div class="col-md-6 borderGrey content">
            <img class="imgSizeExtraOptions" src="img/extra_options/1-serie/drive_chassis/automatische_transmissie.png">
            <h4 class="textModalVariant"> Automatische <br /> transmissie </h4>
            <h6 class="contentCollapse2"> € 2.117,50 </h6>
...
<div class="container">
    <div class="row">
        <div class="col-md-12" style="margin: 35px 0 35px 0;">
            <a href="extra_drivetrainSelection.php">
                <button type="button" class="btn btn-primary btn-lg btn-block btnSize">Aandrijving en onderstel kiezen</button>
            </a>
        </div>
    </div>
</div>
