...
<div class="introText">
    <h1 class="center uppercase">Velgen</h1>
    <h3 class="center"> Selecteer uw velgen</h3>
</div>

<div class="container">
    <div class="row">
        <div class="col-md-3">
            <img class="imgColor" src="img/wheels/styling_546.png">
        </div>
        <div class="col-md-3">
            <img class="imgColor" src="img/wheels/styling_549.png">
        </div>
        <div class="col-md-3">
            <img class="imgColor" src="img/wheels/styling_548.png">
        </div>
        <div class="col-md-3">
            <img class="imgColor" src="img/wheels/styling_488.png">
        </div>
    </div>
...
<div class="container" style="margin-top: 50px;">
    <div class="row">
        <div class="col-md-12">
            <h1>Velg naam hier</h1>
            <h3>Prijs van velg</h3>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-md-12" style="margin: 35px 0 35px 0;">
            <a href="sidemirrorBlacked.php">
                <button type="button" class="btn btn-primary btn-lg btn-block btnSize">Spiegelkappen kiezen</button>
            </a>
        </div>
    </div>
</div>
