...
<div class="introText">
    ...
    <h3 class="center"> Kies je aanbevolen uitrusting</h3>
</div>

<div class="container">
    <div class="row">
        <div class="col-md-6 borderGrey content">
            <img class="imgSizeExtraOptions" src="img/extra_options/1-serie/steeringwheel/sportstuur_leer_bekleding.png">
            <h4 class="textModalVariant"> Sportstuurwiel met <br /> leer bekleding </h4>
        ...
        <div class="col-md-6 borderGrey content">
            <img class="imgSizeExtraOptions" src="img/extra_options/1-serie/steeringwheel/m_sportstuur.png">
            <h4 class="textModalVariant"> M Sportstuurwiel </h4>
        ...
        <div class="col-md-6 borderGrey content">
            <img class="imgSizeExtraOptions" src="img/extra_options/1-serie/steeringwheel/stuurwielrand_verwarmd.png">
            <h4 class="textModalVariant"> Stuurwielrand <br /> verwarmd </h4>
        ...
        <div class="col-md-6 borderGrey content">
            <img class="imgSizeExtraOptions" src="img/extra_options/1-serie/steeringwheel/multifunctioneel_stuurwiel.png">
            <h4 class="textModalVariant"> Multifunctioneel <br /> stuurwiel </h4>
            <h6 class="contentCollapse2"> € 0 </h6>
            <h6 class="contentCollapse3"><img src="img/pijlrechts.png" style="width: 20px;"> Meer details</h6>
            <div class="form-check">
                <input class="form-check-input position-static checkmarkModalVariant2" type="checkbox" id="blankCheckbox" value="option1">
...
<div class="container">
    <div class="row">
        <div class="col-md-12" style="margin: 35px 0 35px 0;">
            <a href="extra_wheelsSelection.php">
                <button type="button" class="btn btn-primary btn-lg btn-block btnSize">Wielen en banden uitrusting kiezen</button>
            </a>
        </div>
    </div>
</div>
