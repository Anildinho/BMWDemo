...
<div class="container">
    <div class="row">
        <div class="col-md-6 borderGrey content">
            <img class="imgSizeExtraOptions" src="img/extra_options/1-serie/seat_seatcomfort/sportstoelen.png">
        ...
        <div class="col-md-6 borderGrey content">
            <img class="imgSizeExtraOptions" src="img/extra_options/1-serie/seat_seatcomfort/elektrischverstelbaar_voorstoelen.png">
            <h5 class="textModalVariant"> Elektrisch verstelbare <br /> lendensteun voorstoelen </h5>
        ...
        <div class="col-md-6 borderGrey content">
            <img class="imgSizeExtraOptions" src="img/extra_options/1-serie/seat_seatcomfort/elektrischverwarmde_voorstoelen.png">
            <h5 class="textModalVariant"> Elektrisch verwarmde <br /> voorstoelen </h5>
...
<div class="container">
    <div class="row">
        <div class="col-md-12" style="margin: 35px 0 35px 0;">
            <a href="extra_steeringSelection.php">
                <button type="button" class="btn btn-primary btn-lg btn-block btnSize">Stuurwielen uitrusting kiezen</button>
            </a>
        </div>
    </div>
</div>
