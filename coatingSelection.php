...
<div class="introText">
    <h1 class="center uppercase">Bekledingen</h1>
    <h3 class="center"> Selecteer uw bekleding</h3>
</div>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-3">
            <img class="imgColor" src="img/coating/senatec_antrhaciet_orange_highlight_black.png">
        </div>
        <div class="col-md-3">
            <img class="imgColor" src="img/coating/senatec_antrhazit_accent_grau.png">
        </div>
    </div>
    <hr>

    <h3 class="h3Title">Leder</h3>
    <div class="row">
        <div class="col-md-3">
            <img class="imgColor" src="img/coating/leather_dakota_magmarot.png">
        </div>
        <div class="col-md-3">
            <img class="imgColor" src="img/coating/leather_dakota_mocha_schwarz.png">
        </div>
        <div class="col-md-3">
            <img class="imgColor" src="img/coating/leather_dakota_schwarz.png">
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12" style="margin: 35px 0 35px 0;">
                <a href="interiorSelection.php">
                    <button type="button" class="btn btn-primary btn-lg btn-block btnSize">Interieurlijst kiezen</button>
                </a>
            </div>
        </div>
    </div>
