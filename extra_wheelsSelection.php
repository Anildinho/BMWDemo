...
<div class="container">
    <div class="row">
        <div class="col-md-6 borderGrey content">
            <img class="imgSizeExtraOptions" src="img/extra_options/1-serie/wheels_tires/banden_reparatieset.png">
            <h4 class="textModalVariant"> Banden reparatieset </h4>
        ...
        <div class="col-md-6 borderGrey content">
            <img class="imgSizeExtraOptions" src="img/extra_options/1-serie/wheels_tires/reservewiel.png">
            <h4 class="textModalVariant"> Reservewiel </h4>
        ...
        <div class="col-md-6 borderGrey content">
            <img class="imgSizeExtraOptions" src="img/extra_options/1-serie/wheels_tires/slotbouten_lm_wielen.png">
            <h4 class="textModalVariant"> Slotbouten voor LM <br /> wielen </h4>
        ...
        <div class="col-md-6 borderGrey content">
            <img class="imgSizeExtraOptions" src="img/extra_options/1-serie/wheels_tires/bandenspannings_systeem.png">
            <h4 class="textModalVariant"> Bandenspannings- <br /> weergavesysteem </h4>
            <h6 class="contentCollapse2"> € 0 </h6>
            <h6 class="contentCollapse3"><img src="img/pijlrechts.png" style="width: 20px;"> Meer details</h6>
            <div class="form-check">
                <input class="form-check-input position-static checkmarkModalVariant2" type="checkbox" id="blankCheckbox" value="option1">
...
<div class="container">
    <div class="row">
        <div class="col-md-12" style="margin: 35px 0 35px 0;">
            <a href="#">
                <button type="button" class="btn btn-primary btn-lg btn-block btnSize">Einde config</button>
            </a>
        </div>
    </div>
</div>
