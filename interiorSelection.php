...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-ride="carousel" data-interval="0">
...
<div class="introText">
    <h1 class="center uppercase">Interieurlijsten</h1>
    <h3 class="center"> Selecteer uw interieurlijst </h3>
</div>

<div class="container">
    <h3 class="h3Title">Stof</h3>
    <div class="row">
        <div class="col-md-3">
            <img class="imgColor" src="img/interior/interior_illuminated_brooklyn.png">
        </div>
        <div class="col-md-3">
            <img class="imgColor" src="img/interior/interior_illuminated_boston.png">
        </div>
        <div class="col-md-3">
            <img class="imgColor" src="img/interior/interior_illuminated_berlin.png">
        </div>
        <div class="col-md-3">
            <img class="imgColor" src="img/interior/interior_illuminated_nizza.png">
        </div>
    </div>
    ...
    <div class="container" style="margin-top: 50px;">
        <div class="row">
            <div class="col-md-12">
                <h1>Bekleding naam hier</h1>
                <h3>Prijs van bekleding</h3>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12" style="margin: 35px 0 35px 0;">
                <a href="packetsEditionsSelection.php">
                    <button type="button" class="btn btn-primary btn-lg btn-block btnSize">Pakketten en Editions kiezen</button>
                </a>
            </div>
        </div>
    </div>
